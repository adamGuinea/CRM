  ...
  handleClick= (link) => {
      Linking.canOpenURL(link).then(supported => {
          if(supported) {
              ...
              console.log('Can\'t open this uri' + link)
          }
      });
  };
    ...
    return (
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style={[theme.cardStyle, styles.card]}>
                ...
                >
                    <Image 
                        source={require('../../ios/CRM/Images.xcassets/closex.png')} 
                    />
                </TouchableOpacity>
                ...
                <TouchableOpacity style={styles.sections} onPress={() => {this.props.updateContact(this.props.person)}}>
                        <MaterialIcon name={'autorenew'} size={40} style={styles.editIcon}/>
                        <Text style={theme.cardContentStyle}>EDIT</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.sections} onPress={() => {this.props.deleteContact(this.props.person.uid)}}>
                ...
                <View style={styles.actionArea}>
                    ...
                    >
                        <Image source={require('../../ios/CRM/Images.xcassets/call2x.png')} style={styles.actionImage} />
                    </TouchableOpacity>
                    <TouchableOpacity 
                        onPress={() => {this.handleClick(`sms:${this.props.person.phone}`)}}
                    >
                        <Image source={require('../../ios/CRM/Images.xcassets/sms2x.png')} style={styles.actionImage} />
                    </TouchableOpacity>
                    <TouchableOpacity 
                        onPress={() => {this.handleClick(`mailto:${this.props.person.email}`)}}
                    >
                        <Image source={require('../../ios/CRM/Images.xcassets/email2x.png')} style={styles.actionImage} />
                    </TouchableOpacity>
                    </View>
                <View style={styles.actionArea}>
                    <Text>Call</Text>
