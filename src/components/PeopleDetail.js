    ...
    return (
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <SimpleIcon name={'close'} size={30} style={styles.closeIcon}
            ...
            <Text style={[theme.cardItem, styles.title1]}>{this.props.person.first_name} {this.props.person.last_name} </Text>
            <Text style={[theme.cardItem, styles.title2]}>from {this.props.person.company}</Text>
