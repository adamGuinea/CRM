...
class AddPerson extends Component {
  ...
  onAddPress(){
    const {first_name, last_name, phone, email, company, notes, project} = this.props;
...
const mapStateToProps = state => {
  const {first_name, last_name, phone, email, company, notes, project} = state;
  return {first_name, last_name, phone, email, company, notes, project};
};
